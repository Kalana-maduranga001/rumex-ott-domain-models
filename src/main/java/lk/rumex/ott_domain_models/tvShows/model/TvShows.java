...
import lk.rumex.ott_domain_models.season.model.Season;
...
@Entity
@Table(name = "tvShows")
public class TvShows extends MediaBase {

    @ManyToMany
    @JoinTable(
            name = "tvShows_directors",
    ...
    @ManyToMany
    @JoinTable(
            name = "tvShows_producers",
            joinColumns = @JoinColumn(name = "tvShows_id"),
            inverseJoinColumns = @JoinColumn(name = "producer_id")
    )
    private List<CastMember> producer;

    @OneToMany(mappedBy = "tvShows", cascade = CascadeType.ALL)
    private List<TvShowsCast> cast;
    ...
    @ManyToMany
    @JoinTable(
            name = "tvShows_listing_countries",
